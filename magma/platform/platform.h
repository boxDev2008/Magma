...
mg_window_create_info_t;

MG_API bool     mg_platform_initialize      (mg_platform_t *platform, mg_window_create_info_t *create_info);
MG_API void     mg_platform_shutdown        (mg_platform_t *platform);

MG_API bool     mg_platform_poll_messages   (mg_platform_t *platform);
