...
void mg_graphics_2d_draw_line(mg_vec2_t point1, mg_vec2_t point2, mg_vec4_t color)
{
    mg_mat4_t model = mg_mat4_identity();
    model = mg_mat4_translate(model, (mg_vec3_t) { 0.5f, 0.5f, 0.0f });
    model = mg_mat4_scale(model, (mg_vec3_t) { mg_vec2_distance(point1, point2), 1.0f, 1.0f });
...
void mg_graphics_2d_draw_text(mg_mat4_t model, mg_vec4_t color, const char *text, mg_font_t *font)
{
    ...
    if (graphics_data.frame_data.vertex_buffer_bind_id != 4)
    {
    ...
    if (graphics_data.frame_data.index_buffer_bind_id != 4)
    {
        ...
        default:
            {
                ...
                graphics_data.text_data.vertices[i * 16 + 1] = y - (q.y1 - q.y0) / MG_CONFIG_GRAPHICS_FONT_HEIGHT;
                ...
                graphics_data.text_data.vertices[i * 16 + 5] = y - (q.y1 - q.y0) / MG_CONFIG_GRAPHICS_FONT_HEIGHT;
                ...
                graphics_data.text_data.vertices[i * 16 + 9] = y;
                ...
                graphics_data.text_data.vertices[i * 16 + 13] = y;
                ...
                case 'y':
                case 'q':
                    graphics_data.text_data.vertices[i * 16 + 1] += 0.675f;
                    graphics_data.text_data.vertices[i * 16 + 5] += 0.675f;
                    graphics_data.text_data.vertices[i * 16 + 9] += 0.675f;
                    graphics_data.text_data.vertices[i * 16 + 13] += 0.675f;
                    break;
                case '\'':
                case '\"':
                case '`':
                    graphics_data.text_data.vertices[i * 16 + 1] -= 0.45f;
                    graphics_data.text_data.vertices[i * 16 + 5] -= 0.45f;
                    graphics_data.text_data.vertices[i * 16 + 9] -= 0.45f;
                    graphics_data.text_data.vertices[i * 16 + 13] -= 0.45f;
                    break;
                }

                x += (q.x1 - q.x0) / MG_CONFIG_GRAPHICS_FONT_HEIGHT + 0.1f;
            }
        }
    }
...
{
    if (graphics_data.frame_data.pipeline_bind_id != 5)
    {
        mg_rhi_renderer_bind_pipeline(graphics_data.mesh_data.pipeline);
        graphics_data.frame_data.pipeline_bind_id = 5;
        graphics_data.frame_data.vertex_buffer_bind_id = 5;
        graphics_data.frame_data.index_buffer_bind_id = 5;
    }
