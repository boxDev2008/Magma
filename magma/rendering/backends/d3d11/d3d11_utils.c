...
DXGI_FORMAT mg_d3d11_get_pixel_format(mg_pixel_format format)
{
    switch (format)
    {
        ...
        case MG_PIXEL_FORMAT_R16G16_SFLOAT:
        ...
        case MG_PIXEL_FORMAT_R16G16B16_SFLOAT:
        ...
        case MG_PIXEL_FORMAT_R16G16B16A16_SFLOAT:
        ...
        case MG_PIXEL_FORMAT_R32G32B32A32_SFLOAT:
            return DXGI_FORMAT_R32G32B32A32_FLOAT;

        case MG_PIXEL_FORMAT_R64G64B64_UINT:
        case MG_PIXEL_FORMAT_R64G64B64_SINT:
        case MG_PIXEL_FORMAT_R64G64B64_SFLOAT:
